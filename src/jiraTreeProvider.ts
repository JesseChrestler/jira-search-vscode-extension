...
export class JiraTreeProvider implements vscode.TreeDataProvider<Dependency> {
  ...
  //         }
  //       };
  //       const deps = packageJson.dependencies ? Object.keys(packageJson.dependencies).map(toDep) : [];
  //       const devDeps = packageJson.devDependencies ? Object.keys(packageJson.devDependencies).map(toDep) : [];
